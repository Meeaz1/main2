...
waka_sound = pygame.mixer.Sound("sound/waka.wav")
...
def draw_misc():
    ...
    if game_over:
        ...
        gameover_text = font.render('Гру закінченно! Пробіл для рестарту!', True, 'red')
    ...
    if game_won:
        ...
        pygame.draw.rect(screen, 'white', [50, 200, 800, 300],0, 10)
        pygame.draw.rect(screen, 'dark gray', [70, 220, 760, 260], 0, 10)
        gameover_text = font.render('Перемогу! Пробіл для рестарту!', True, 'green')
        screen.blit(gameover_text, (100, 300))
    ...
    if 0 < player_x < 870:
        if level[center_y // num1][center_x // num2] == 1:
            ...
            if not pygame.mixer.Channel(0).get_busy():
                pygame.mixer.Channel(0).play(waka_sound)
